class track:
    def __init__(self, spotify_track):
        ...
        self.ean = spotify_track['track']['external_ids']['ean'] if 'ean' in spotify_track['track']['external_ids'] else None
        self.upc = spotify_track['track']['external_ids']['upc'] if 'upc' in spotify_track['track']['external_ids'] else None
    ...
    def display(self) :
        ...
        print(artists + " - " + self.name + " - " + self.album_name + " - " + duration + " - " + str(self.isrc) + "|" + str(self.ean) + "|" + str(self.upc) + " - " + self.spotify_id)
    
    def display_JSON(self) :
        print(self.spotify_JSON)